            ...
            Padding(
              ...
              child: Row (
                children: [
                  ...
                  ElevatedButton(
                    onPressed: ()=> {
                      Navigator.pushNamed(context, '/bidtrip')
                    },
            ...
            Center(
              child: WidgetCircularAnimator(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text('Total trips: $tripsCount',
                      style: const TextStyle( color: Colors.white, fontFamily: 'SpaceMono', fontSize: 15.0, fontWeight: FontWeight.bold, ),)
                  ),
                ),
              ),
            ),
